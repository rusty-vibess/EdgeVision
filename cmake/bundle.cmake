...
if(NOT DEFINED EDGEVISION_BUILD_TYPE)
    message(FATAL_ERROR "EDGEVISION_BUILD_TYPE is not set")
endif()
if(NOT DEFINED EDGEVISION_SOURCE_DIR)
    message(FATAL_ERROR "EDGEVISION_SOURCE_DIR is not set")
endif()
...
if(EDGEVISION_BUILD_TYPE STREQUAL "Debug")
    message(STATUS "Bundle: copying suppression")
    if(NOT EXISTS "${EDGEVISION_SOURCE_DIR}/cmake/suppressions")
        message(STATUS "${EDGEVISION_SOURCE_DIR}/cmake/suppressions")
        message(WARNING "Bundle: suppressions missing")
    else()
        file(MAKE_DIRECTORY "${EDGEVISION_BUNDLE_DIR}/cmake/suppressions")
        file(COPY "${EDGEVISION_SOURCE_DIR}/cmake/suppressions/" DESTINATION "${EDGEVISION_BUNDLE_DIR}/cmake/suppressions")
        message(STATUS "Bundle: suppressions copy success")
    endif()
endif()
