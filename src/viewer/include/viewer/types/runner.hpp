...
namespace edgevision::viewer {
    ...
    struct SceneViewerRunnerStatus {
        ...
        /// Total number of published outputs marked stale.
        std::size_t staleOutputCount = 0;
        ...
        /// Whether the last published output was marked stale.
        bool lastOutputWasStale = false;
    };
